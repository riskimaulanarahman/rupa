...
<div>
    ...
    <textarea
        ...
        {{ $attributes->merge(['class' => "w-full px-4 py-2.5 max-sm:py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 {$themeRing} transition resize-none"]) }}
