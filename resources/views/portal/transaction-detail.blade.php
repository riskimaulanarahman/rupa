...
<div class="max-w-3xl mx-auto space-y-6">
    <!-- Back Button -->
    <a href="{{ customer_route('transactions') }}" class="inline-flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400">
