...
@section('title', __('service_category.add'))
@section('page-title', __('service_category.add'))
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 max-sm:p-4">
        <form action="{{ route('service-categories.store') }}" method="POST" class="space-y-6 max-sm:space-y-4">
            @csrf
